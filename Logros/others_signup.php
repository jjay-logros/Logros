...
<html>
  <head>
    ...
    <link rel="stylesheet" type="text/css" href="css/others_signup_stylesheet.css">
  </head>

  <body>
    <h3 style="color:white; font-weight: bold; text-align: center; font-size:40px">WELCOME!<br><br> SIGN UP, PLEASE!</h3>
    <h3 padding: -2000px; margin: -2000px; div class="container">
      ...
      ?>
      <form action="includes/others_signup.inc.php" method="post">
